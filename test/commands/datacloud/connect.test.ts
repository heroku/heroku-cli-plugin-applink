    ...
    context(
      ...
      function () {
        beforeEach(function () {
          ...
          applinkApi
            .post(
              '/addons/01234567-89ab-cdef-0123-456789abcdef/connections/datacloud'
            )
        ...
        context('when the connection succeeds', function () {
          beforeEach(function () {
            applinkApi
              .get(
                '/addons/01234567-89ab-cdef-0123-456789abcdef/connections/339b373a-5d0c-4056-bfdd-47a06b79f112'
              )
          ...
          it('shows the URL that will be opened for the OAuth flow', async function () {
            ...
            expect(stderr.output).to.contain(
              `Opening browser to ${connection4_connecting.redirect_uri}`
            );
          });
          ...
          it('attempts to open the browser to the redirect URI', async function () {
            ...
            expect(
              urlOpener.calledWith(connection4_connecting.redirect_uri, {
                wait: false,
              })
            ).to.equal(true);
          });
