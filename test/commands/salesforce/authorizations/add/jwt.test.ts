...
describe('salesforce:authorizations:add:jwt', function () {
  ...
  describe('happy path', function () {
    it('successfully creates JWT authorization with status authorized', async function () {
      ...
      applinkApi
        .post(
          '/addons/01234567-89ab-cdef-0123-456789abcdef/authorizations/salesforce/jwt',
          (body) => {
            requestBody = body;
            return true;
          }
        )
        .reply(202, authorization_jwt_authorized);
    ...
    it('successfully creates JWT authorization with failed status', async function () {
      applinkApi
        ...
        .reply(202, authorization_jwt_failed);
    ...
    it('successfully creates JWT authorization with authorizing status', async function () {
      applinkApi
        ...
        .reply(202, authorization_jwt_authorizing);
  ...
  describe('multiple add-ons', function () {
    ...
    it('correctly selects target add-on with --addon flag', async function () {
      ...
      const multiAddonApplinkApi = nock('https://applink-api.heroku.com')
        .post(
          '/addons/6789abcd-ef01-2345-6789-abcdef012345/authorizations/salesforce/jwt'
        )
        .reply(202, authorization_jwt_authorized);
  ...
  describe('error handling', function () {
    ...
    it('handles 401 authentication failure', async function () {
      applinkApi
        ...
        .reply(401, { message: 'Authentication failed', id: 'unauthorized' });
    ...
    it('handles 500 server error', async function () {
      applinkApi
        ...
        .reply(500, { message: 'Internal server error', id: 'server_error' });
