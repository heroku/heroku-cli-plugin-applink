...
import Cmd from '../../../../src/commands/events/subscriptions/destroy'
import stripAnsi from '../../../helpers/strip-ansi'
import {CLIError} from '@oclif/core/lib/errors'
import {addon, subscription2} from '../../../helpers/fixtures'
import heredoc from 'tsheredoc'

describe('events:subscriptions:destroy', function () {
  let api: nock.Scope
  ...
  context('when the user uses the --confirm flag', function () {
    ...
    it('shows the expected output when the app name with the --confirm flag does match and the command is successful', async function () {
      eventsApi
        .delete('/v1/tenants/01234567-89ab-cdef-0123-456789abcdef/subscriptions/fakeOrgAccountChange')
      ...
      expect(stripAnsi(stderr.output)).to.eq(heredoc`
        Destroying subscription fakeOrgAccountChange on my-app...
        Destroying subscription fakeOrgAccountChange on my-app... done
      `)
    })
  })
